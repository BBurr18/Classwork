 ...
 * get you started.
 * 
 * @author mvail, mhthomas, amussell (lambdas),Brandon Burr
 */
public class ListTester {
	...
	private void runTests() {
		...
		testSingleElementList(emptyList_addAat0_A, "emptyList_addAat0_A", LIST_A, STRING_A);
		testSingleElementList(emptyList_addToFrontA_A, "emptyList_addToFrontA_A", LIST_A, STRING_A);
		...
		// 1-element to changed 1-element
		testSingleElementList(A_size_A, "A_size_A", LIST_A, STRING_A);

		// 1-element to 1-element via get()
		testSingleElementList(A_get0_A, "A_get0_A()", LIST_A, STRING_A);
		...
		testTwoElementList(A_addBat0_BA, "A_addBat0_BA", LIST_BA, STRING_BA);
		testTwoElementList(A_addBat1_AB, "A_addBat1_AB", LIST_AB, STRING_AB);
		...
		testThreeElementList(AB_addCat1_ACB, "AB_addCat1_ACB", LIST_ACB, STRING_ACB);
		...
		testThreeElementList(AB_addCat0_CAB, "AB_addCat0_CAB", LIST_CAB, STRING_CAB);
		testThreeElementList(AB_addCat2_ABC, "AB_addCat2_ABC", LIST_ABC, STRING_ABC);
		...
		testThreeElementList(ABC_se1toD_ADC, "ABC_set1toD_ADC", LIST_ADC, STRING_ADC);
		...
		testEmptyList(emptyList_iterator, "emptyList_iterator");

		// 1-element iterator tests
		testSingleElementList(A_iterator_A, "A_iterator_A", LIST_A, "STRING_A");
		testSingleElementList(A_iterHasNext_A, "A_iterHasNext_A", LIST_A, "STRING_A");
		testSingleElementList(A_iterNext_A, "A_iterNext_A", LIST_A, "STRING_A");
		testSingleElementList(AB_iterRemoveAAfternextA_B, "AB_iterRemoveAAfternextA_B", LIST_B, STRING_B);
		testSingleElementList(AB_iterRemoveBAfterNextB_A, "AB_iterRemoveBAfterNextB_A", LIST_A, STRING_A);
		...
		// 2- element list iterator 
		testTwoElementList(ABC_listIterRemoveAfterPreviousC_AB, "ABC_IterRemoveAfterPreviousC_AB", LIST_AB, STRING_AB);
		...
		testTwoElementList(A_listIterAddWithNewIteratorB_BA, "AB_listIterAddWithNewIteratorB_BA", LIST_BA, STRING_BA);
		
		testTwoElementList(A_listIterSetCAfterNextA_CB, "A_listIterSetCAfterNextA_CB", LIST_CB, STRING_CB);
		...
		// 3 - element list Iterator 
		testThreeElementList(AB_listIterAddWithNewIteratorC_CAB, "AB_listIterAddWithNewIteratorC_CAB", LIST_CAB, STRING_CAB);
	...
	/**
	 * Scenario: empty list -> addAt(0,A) -> [A]
	 * 
	 * @return [A] after addAt(0,A)
	 */
	private IndexedUnsortedList<Integer> emptyList_addAat0_A() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(0, ELEMENT_A);
		return list;
	}

	private Scenario<Integer> emptyList_addAat0_A = () -> emptyList_addAat0_A();
	...
	/**
	 * Scenario: [A,B] -> add(1,C) -> [A]
	 * 
	 * @return [A,C,B] after add(1,C)
	 */
	private IndexedUnsortedList<Integer> AB_addCat1_ACB() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		list.add(1, ELEMENT_C);
		return list;
	}

	private Scenario<Integer> AB_addCat1_ACB = () -> AB_addCat1_ACB();

	/**
	 * Scenario: empty list -> iterator() -> []
	 * 
	 * @return [] after iterator()
	 */
	private IndexedUnsortedList<Integer> emptyList_iterator() {
		IndexedUnsortedList<Integer> list = newList();
		list.iterator();
		return list;
	}

	private Scenario<Integer> emptyList_iterator = () -> emptyList_iterator();

	/**
	 * Scenario: [A] -> iterator() -> [A]
	 * 
	 * @return [A] after iterator()
	 */
	private IndexedUnsortedList<Integer> A_iterator_A() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.iterator();
		return list;
	}

	private Scenario<Integer> A_iterator_A = () -> A_iterator_A();

	/**
	 * Scenario: [A] -> iterHasNext() -> [A]
	 * 
	 * @return true after iterHasNext()
	 */
	private IndexedUnsortedList<Integer> A_iterHasNext_A() {
		IndexedUnsortedList<Integer> list = A_iterator_A();
		Iterator<Integer> it = list.iterator();
		it.hasNext();
		return list;
	}

	private Scenario<Integer> A_iterHasNext_A = () -> A_iterHasNext_A();

	/**
	 * Scenario: [A] -> iterNext() -> [A]
	 * 
	 * @return [A] after iterNext()
	 */
	private IndexedUnsortedList<Integer> A_iterNext_A() {
		IndexedUnsortedList<Integer> list = A_iterator_A();
		Iterator<Integer> it = list.iterator();
		it.next();
		return list;
	...
	private Scenario<Integer> A_iterNext_A = () -> A_iterNext_A();
	...
	/**
	 * Scenario: [A,B] -> [A,B] -> iterator remove() after next() returns A -> [B] 
	 * 
	 * @return [B] after iterRemove()
	 */
	private IndexedUnsortedList<Integer> AB_iterRemoveAAfternextA_B() {
	...
	private Scenario<Integer> AB_iterRemoveAAfternextA_B = () -> AB_iterRemoveAAfternextA_B();

	/**
	 * 46) [A,B] -> iterator remove() after next() returns B -> [A]
	 * 
	 * @return [A] after iterRemove()
	 */
	private IndexedUnsortedList<Integer> AB_iterRemoveBAfterNextB_A() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		Iterator<Integer> it = list.iterator();
		it.next();
		it.next();
	...
	private Scenario<Integer> AB_iterRemoveBAfterNextB_A = () -> AB_iterRemoveBAfterNextB_A();
	 ...
	 * @return [A] after size()
	 */
	private IndexedUnsortedList<Integer> A_size_A() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.size();
		return list;
	}

	private Scenario<Integer> A_size_A = () -> A_size_A();
	...
	/**
	 * Scenario: [A] -> addAt(0,B) -> [B,A]
	 * 
	 * @return [B,A] after addAt(0,B)
	 */
	private IndexedUnsortedList<Integer> A_addBat0_BA() {
		IndexedUnsortedList<Integer> list = emptyList_addA_A();
		list.add(0, ELEMENT_B);
		return list;
	}

	private Scenario<Integer> A_addBat0_BA = () -> A_addBat0_BA();

	/**
	 * Scenario: [A,B] -> addAt(1,B) -> [A,B]
	 * 
	 * @return [A,B] after addAt(1,B)
	 */

	private IndexedUnsortedList<Integer> A_addBat1_AB() {
		IndexedUnsortedList<Integer> list = emptyList_addA_A();
		list.add(1, ELEMENT_B);
		return list;
	}

	private Scenario<Integer> A_addBat1_AB = () -> A_addBat1_AB();
	...
	private Scenario<Integer> A_removeA = () -> A_removeA_();
	...
	/**
	 * Scenario: [AB] -> AB_set0ToC_CB -> [CB]
	 * 
	 * @return [CB] after set(0,C)
	 */
	 ...
	 * Scenario: [A] -> get(0) -> [A]
	 * 
	 * @return [A] after get(0)
	 */
	private IndexedUnsortedList<Integer> A_get0_A() {
		IndexedUnsortedList<Integer> list = AB_removeB_A();
		list.get(0);
		return list;
	}

	private Scenario<Integer> A_get0_A = () -> A_get0_A();
	...
	/**
	 * Scenario: [AB] -> AB_addC_ABC -> [ABC]
	 * 
	 * @return [ABC] after add(C)
	 */
	private IndexedUnsortedList<Integer> AB_addC_ABC() {
		IndexedUnsortedList<Integer> list = A_addAfterB_AB();
		list.add(ELEMENT_C);
		return list;
	}
	...
	/**
	 * Scenario: [AB] -> AB_addToFront(C)_ABC -> [ABC]
	 * 
	 * @return [CAB] after addToFront(C)
	 */
	...
	/**
	 * Scenario: [AB] -> AB_addToRear(C)_ABC -> [ABC]
	 * 
	 * @return [CAB] after addToRear(C)
	 */
	...
	/**
	 * Scenario: [AB] -> AB_addCAfterA_ACB-> [ACB]
	 * 
	 * @return [ACB] after addAfer(C,A)
	 */
	...
	/**
	 * Scenario: [AB] ->AB_addCAfterB_ABC-> [ABC]
	 * 
	 * @return [ABC] after addAfer(C,A)
	 */
	...
	/**
	 * Scenario: [AB] ->AB_addCat0_CAB-> [CAB]
	 * 
	 * @return [CAB] after addAT(0,C)
	 */
	private IndexedUnsortedList<Integer> AB_addCat0_CAB() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		list.add(0, ELEMENT_C);
		return list;
	}

	private Scenario<Integer> AB_addCat0_CAB = () -> AB_addCat0_CAB();

	/**
	 * Scenario: [AB] -> AB_addCat2_ABC-> [ABC]
	 * 
	 * @return [ABC] after addAt(2,C)
	 */
	private IndexedUnsortedList<Integer> AB_addCat2_ABC() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		list.add(2, ELEMENT_C);
		return list;
	}

	private Scenario<Integer> AB_addCat2_ABC = () -> AB_addCat2_ABC();

	/**
	 * Scenario: [ABC] -> ABC_removeFirst_BC-> [BC]
	 * 
	 * @return [BC] after removeFirst()
	 */
	...
	/**
	 * Scenario: [ABC] -> ABC_ABC_removeLast_AB-> [AB]
	 * 
	 * @return [AB] after removeLast()
	 */
	...
	/**
	 * Scenario: [ABC] -> ABC_removeA_BC-> [BC]
	 * 
	 * @return [BC] after remove(A)
	 */
	...
	/**
	 * Scenario: [ABC] -> ABC_removeB_AC-> [AC]
	 * 
	 * @return [AC] after remove(B)
	 */
	...
	/**
	 * Scenario: [ABC] -> ABC_removeC_AB-> [AB]
	 * 
	 * @return [AB] after remove(C)
	 */
	...
	/**
	 * Scenario: [ABC] -> ABC_remove0_BC-> [BC]
	 * 
	 * @return [BC] after remove(0)
	 */
	...
	/**
	 * Scenario: [ABC] -> ABC_remove1_AC-> [AC]
	 * 
	 * @return [AC] after remove(1)
	 */
	...
	/**
	 * Scenario: [ABC] -> ABC_remove2_AB-> [AB]
	 * 
	 * @return [AB] after remove(2)
	 */
	...
	private Scenario<Integer> ABC_se1toD_ADC = () -> ABC_se1toD_ADC();
	...
	/**
	 * Scenario: [A,B,C] -> iterator remove() after next() returns B -> [A,C]-> [AC]
	 * 
	 * @return [AC] after iter.remove()
	 */
	...
	/**
	 * Scenario: [A,B,C] -> iterator remove() after previous() returns A -> [BC]
	 * 
	 * @return [BC] after lit.remove()
	 */
	...
	/**
	 * Scenario: [A,B,C] -> iterator remove() after previous() returns B -> [AC]
	 * 
	 * @return [AC] after lit.remove()
	 */
	...
	/**
	 * Scenario: [ABC] -> iterator remove() after previous() returns C -> [AB]
	 * 
	 * @return [AB] after lit.remove()
	 */
	...
	/**
	 * Scenario: [A] ->  iterator add(B) with new iterator -> [BA]
	 * 
	 * @return [BA] after listIt.add(B)
	 */
	private IndexedUnsortedList<Integer> A_listIterAddWithNewIteratorB_BA() {
		IndexedUnsortedList<Integer> list  = newList();
	...
	private Scenario<Integer> A_listIterAddWithNewIteratorB_BA = () -> A_listIterAddWithNewIteratorB_BA();


	/**
	 * Scenario: [A] -> iterator add(B) after next() returns A -> [AB]
	 * 
	 * @return [AB] after lit.add(B)
	 */
	...
	/**
	 * Scenario: [A] -> iterator add(B) after previous() returns A-> [BA]
	 * 
	 * @return [BA] after lit.add(B)
	 */
	...
	/**
	 * Scenario: [AB] ->  iterator add(C) with new iterator -> [CAB]
	 * 
	 * @return [CAB] after listIt.add(C)
	 */
	private IndexedUnsortedList<Integer> AB_listIterAddWithNewIteratorC_CAB() {
		IndexedUnsortedList<Integer> list  = newList();
		ListIterator<Integer> listIter = list.listIterator();
		listIter.add(ELEMENT_A);
	...
	private Scenario<Integer> AB_listIterAddWithNewIteratorC_CAB = () -> AB_listIterAddWithNewIteratorC_CAB();
	
	/**
	 * Scenario: [AB] ->  iterator add(C) after next() returns A-> [ACB]
	 * 
	 * @return [ACB] after lit.add(C)
	 */
	...
	/**
	 * Scenario: [AB] ->  iterator add(C) after next() returns B-> [ABC]
	 * 
	 * @return [ABC] after lit.add(C)
	 */
	...
	/**
	 * Scenario: [AB] -> iterator add(C) after previous() returns A-> [CAB]
	 * 
	 * @return [CAB] after listIterator.add(C)
	 */
	...
	/**
	 * Scenario: [AB] -> iterator add(C) after previous() returns B -> [ACB]
	 * 
	 * @return [ACB] after lit.add(C)
	 */
	 ...
	 * 
	 * @return [B] after listIterator.set(B)
	 */
	...
	/**
	 * Scenario: [AB] -> iterator set(C) after next() returns A -> [CB]
	 * 
	 * @return [CB] after lit.set(C)
	 */
	private IndexedUnsortedList<Integer> A_listIterSetCAfterNextA_CB() {
		IndexedUnsortedList<Integer> list  = A_addB_AB();
		ListIterator<Integer> lit = list.listIterator();
		lit.next();
		lit.set(ELEMENT_C);
	...
	private Scenario<Integer> A_listIterSetCAfterNextA_CB = () -> A_listIterSetCAfterNextA_CB();
	
	/**
	 * Scenario: [AB] ->  iterator set(C) after next() returns B -> [A,C]
	 * 
	 * @return [AC] after lit.set(C)
	 */
	...
	/**
	 * Scenario: [AB] -> iterator set(C) after previous() returns A -> [C,B]
	 * 
	 * @return [CB] after lit.set(C)
	 */
	...
	/**
	 * Scenario: [AB] -> iterator set(C) after previous() returns B -> [AC]
	 * 
	 * @return [AC] after lit.set(C)
	 */
	...
	/**
	 * Scenario: [ABC] -> iterator set(D) after next() returns A -> [DBC]
	 * 
	 * @return [DBC] after lit.set(D)
	 */
	...
	/**
	 * Scenario: [ABC] -> iterator set(D) after next() returns B -> [ADC]
	 * 
	 * @return [ADC] after lit.set(D)
	 */
	...
	/**
	 * Scenario: [ABC] -> iterator set(D) after next() returns C -> [ABD]
	 * 
	 * @return [ABD] after lit.set(D)
	 */
	...
	/**
	 * Scenario: [ABC] -> iterator set(D) after previous() returns A -> [DBC]
	 * 
	 * @return [DBC] after lit.set(D)
	 */
	...
	/**
	 * Scenario: [ABC] -> iterator set(D) after previous() returns B -> [ADC]
	 * 
	 * @return [ADC] after listIterator.set(D)
	 */
	...
	/**
	 * Scenario: [ABC] ->  iterator set(D) after previous() returns C -> [ABD]
	 * 
	 * @return [ABD] after lit.set(D)
	 */
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents,
		...
		try {
			...
			printTest(scenarioName + "_testRemoveFirst",
					testRemoveFirst(scenario.build(), contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testRemoveLast",
					testRemoveLast(scenario.build(), contents[contents.length - 1], Result.MatchingValue));
			printTest(scenarioName + "_testRemove" + contentsString.charAt(0),
					testRemoveElement(scenario.build(), contents[0], Result.MatchingValue));
			...
			printTest(scenarioName + "_testFirst", testFirst(scenario.build(), contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testLast",
					testLast(scenario.build(), contents[contents.length - 1], Result.MatchingValue));
			...
			printTest(scenarioName + "_testIsEmpty", testIsEmpty(scenario.build(), Result.False));
			printTest(scenarioName + "_testSize", testSize(scenario.build(), contents.length));
			printTest(scenarioName + "_testToString", testToString(scenario.build(), Result.ValidString));
			...
			printTest(scenarioName + "_iterNext_testIterNext",
					testIterNext(iterAfterNext(scenario.build(), 0), contents[0], Result.MatchingValue));
			printTest(scenarioName + "_iterNext_testIterNext",
			...
			printTest(scenarioName + "_iterNext_testIterRemove",
					testIterRemove(iterAfterNext(scenario.build(), 0), Result.IllegalState));
			printTest(scenarioName + "_iterNext_testIterRemove",
					testIterRemove(iterAfterNext(scenario.build(), 1), Result.NoException));
			printTest(scenarioName + "_iterNext_testIterRemove",
			...
			if (SUPPORTS_LIST_ITERATOR) {
				...
				printTest(scenarioName + "_testListIter1HasNext",testIterHasNext(scenario.build().listIterator(2), Result.False));

				printTest(scenarioName + "_testListIter1Next",testIterNext(scenario.build().listIterator(1), contents[1], Result.MatchingValue));
				printTest(scenarioName + "_testListIter1Next",testIterNext(scenario.build().listIterator(2), null, Result.NoSuchElement));
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents,
		...
		try {
			...
			if (SUPPORTS_LIST_ITERATOR) {
				...
				printTest(scenarioName + "_testListIter1HasNext",testIterHasNext(scenario.build().listIterator(1), Result.True));
				printTest(scenarioName + "_testListIter1HasNext",testIterHasNext(scenario.build().listIterator(2), Result.True));

				printTest(scenarioName + "_testListIter1HasNext",testIterHasNext(scenario.build().listIterator(3), Result.False));

				printTest(scenarioName + "_testListIter1Next",testIterNext(scenario.build().listIterator(1), contents[1], Result.MatchingValue));
				printTest(scenarioName + "_testListIter1Next",testIterNext(scenario.build().listIterator(2), contents[2], Result.MatchingValue));
				printTest(scenarioName + "_testListIter1Next",testIterNext(scenario.build().listIterator(3), null, Result.NoSuchElement));
	...
	private void test_ListIterConcurrency() {
		...
		try {
			...
			it1 = list.listIterator();// set and remove are going to modify the last returned element
